...
namespace developwithpassion.specifications
{
    ...
    where Class : class
  {
    ...
    public IMaintainStateForATest<Class> test_state { get; private set; }

    public DefaultObservationController(IManageFakes fakes_controller, IMaintainStateForATest<Class> test_state,
      ICreateAndManageDependenciesFor<Class> factory)
    {
