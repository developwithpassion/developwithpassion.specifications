...
namespace developwithpassion.specification.specs
{
    public class SUTFactorySpecs
    {
        ...
        public abstract class concern_for_type_with_non_fakeable_ctor_parameters : Observes
        {
        ...
        public class ItemWithNonFakeableCtorParameters
        {
            ...
            public ItemWithNonFakeableCtorParameters(IDbConnection connection, IDbCommand command, int number)
            {
                this.connection = connection;
                this.command = command;
                this.number = number;
            ...
            concern_for_type_with_non_fakeable_ctor_parameters
        {
                ...
                when_creating_a_type_that_has_constructor_parameters_that_cant_be_faked
            {
                ...
                It should_throw_the_original_exception_thrown_by_the_default_factory = () =>
            ...
            {
                Establish c = () =>
                    constructor_parameters.Add(typeof(int), 3);

                Because b = () =>
                    result = sut.create();

                It should_be_able_to_be_created_without_issues = () =>
                    result.number.ShouldEqual(3);
            }
        }
