...
namespace developwithpassion.specifications.core.factories
{
  ...
  {
    ICreateANonGenericToGenericFakeAdapter fakes_adapter_factory;
    ICreateTheFakesGateway fakes_gateway_factory;
    ICreateTheFactoryThatCreatesTheSUT sut_factory_provider;
    ICreateTheTestState test_state_factory;

    public MainControllerFactory(ICreateTheFakesGateway fakes_gateway_factory,
                                 ICreateANonGenericToGenericFakeAdapter fakes_adapter_factory,
                                 ICreateTheFactoryThatCreatesTheSUT sut_factory_provider,
                                 ICreateTheTestState test_state_factory)
    {
      ...
      where Engine : IFakeEngine, new()
    {
      ...
      var sut_factory = this.sut_factory_provider.create<Class>(fakes_resolver, fakes_accessor);
    ...
    {
      return new MainControllerFactory(new FakeGatewayFactory(), new FakesAdapterFactory(), new SUTFactoryProvider(),
