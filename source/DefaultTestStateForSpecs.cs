...
{
  public class DefaultTestStateForSpecs
  {
    ...
    public class concern : use_engine<MoqFakeEngine>.observe
    {
      ...
      protected static DefaultTestStateFor<SomeItem> concrete_sut
      {
        get { return sut.downcast_to<DefaultTestStateFor<SomeItem>>(); }
      }

      protected static ICreateAndManageDependenciesFor<SomeItem> factory;
      protected static IList<ObservationPair> setup_behaviours;
      protected static IMaintainStateForATest<SomeItem> sut;
