...
namespace developwithpassion.specifications.specs.issues
{
  ...
  {
    public abstract class concern : use_engine<RhinoFakeEngine>.observe<IAssemblyStore,
      AssemblyStore>
    {
    }
    ...
    public class concern_for_an_assembly_store_with_assemblies_added :
      use_engine<RhinoFakeEngine>.observe<IAssemblyStore, AssemblyStore>
    {
      Establish c = () =>
      {
